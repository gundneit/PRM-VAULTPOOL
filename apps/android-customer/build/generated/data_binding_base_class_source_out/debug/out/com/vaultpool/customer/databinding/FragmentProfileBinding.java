...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnLogout, @NonNull MaterialButton btnStaff,
      @NonNull MaterialButton btnUserDashboard, @NonNull CardView cardProfile,
      @NonNull ProgressBar progressBar, @NonNull TextView tvEmailLabel,
      @NonNull TextView tvEmailValue, @NonNull TextView tvHeader,
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, btnLogout, btnStaff,
